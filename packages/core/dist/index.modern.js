import { GraphNode, $attributes, GraphEdge, $immutableKeys, isRefList, isRefMap, isRef, Graph } from 'property-graph';
...
class NodeIO extends PlatformIO {
  ...
  async _writeGLTF(uri, doc) {
    ...
    const pending = Object.keys(resources).map(async function (resourceURI) {
      ...
      _this.lastWriteBytes += resource.byteLength;
    });
